/**
 * Material UI breakpoints for CSS grid generation, defining minimum viewport widths and optional labels for different layout variations.
 *
 ...
 * @property {[number, string]} xl - Breakpoint for extra large desktop screens (1536px or greater).
 */
export const materialUIBreakpoints = {
	...
	xl: [1536, "Extra Large Desktop"], // Viewport width is 1536px or greater
}
