/**
 * Materialize breakpoints for CSS grid generation, defining minimum viewport widths and optional labels for different layout variations.
 *
 * @type {Object.<string, [number, string]>}
 * @property {[number, string]} sm - Breakpoint for mobile screens (0px or greater).
 * @property {[number, string]} md - Breakpoint for tablet screens (600px or greater).
 ...
 */
export const materializeBreakpoints = {
	sm: [0, "Mobile"], // Viewport width is 0px or greater
	md: [600, "Tablet"], // Viewport width is 600px or greater
